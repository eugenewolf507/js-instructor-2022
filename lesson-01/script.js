...
// вигляді рядків (спеціально для завдання). Не цілі числа можуть бути задані 
// у вигляді `24.7` або `24,7`, тобто як роздільник дробової частини може бути
// кома. Math.pow(2, 4)
...
const weightNumber = Number.parseFloat(weightWithDot)
const heightNumber = Number.parseFloat(height)

const bmi = (weightNumber / Math.pow(heightNumber, 2)).toFixed(1);
console.log(bmi); // 28.8

// ## Example 7 - Оператори порівняння та приведення типів - charCodeAt
